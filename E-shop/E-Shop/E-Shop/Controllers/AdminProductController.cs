...
namespace E_Shop.Controllers
{
    ...
    public class AdminProductController : Controller
    {
        ...
        {
            return View(productRepository.List().ToPagedList(sayfa,3));//sayfa açıldığında 3 tane değer alacak ve diğer değerleri 2. sayfaya atacak
        }
        ...
        [HttpPost]
        public ActionResult Create(Product data,HttpPostedFileBase File)//Resim aldığımız için httpposted
        {
